...
(() => {
  ...
  class WorldMap extends Chart {
    constructor(selector, params = {}) {
      ...
      this.topoworld = topojson.feature(this.world, this.world.objects.world3);
  ...
  Map.createWorldMap = (selector, world, params = {}) => {
    ...
    const countries = topojson
      .feature(world, world.objects.world3)
    ...
    nodeG
      .append("path")
      .datum(topojson.mesh(world, world.objects.world3, (a, b) => a !== b))
      .attr("class", "boundary")
      .attr("d", path);
    ...
    function zoomTo(d) {
      ...
      const s = Math.max(
        1,
        Math.min(8, 0.7 / Math.max(dx / width, dy / height))
      );
